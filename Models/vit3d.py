...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=(224, 224, 32), patch_size=(16, 16, 4), in_c=1, embed_dim=768):
        super().__init__()
...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=(224, 224, 32), patch_size=(16, 16, 4), in_c=1, num_classes=2,
                 embed_dim=768, depth=12, num_heads=12, mlp_ratio=4.0, qkv_bias=True, qk_scale=None,
                 representation_size=None, distilled=False, drop_ratio=0., attn_drop_ratio=0.,
...
def vit_base_patch16_224_3d(num_classes=2):
